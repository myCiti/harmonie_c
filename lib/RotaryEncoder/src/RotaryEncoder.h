...
public:
  ...
  // ----- Constructor -----
  RotaryEncoder(int pin1, int pin2, int pin3, LatchMode mode = LatchMode::FOUR0);
...
private:
  int _pin1, _pin2, _pin3; // Arduino pins used for the encoder.
  ...
  bool _buttonPressed;  // state of button
};
